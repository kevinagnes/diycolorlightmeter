...

{
    ...
    //////////////////////////// CINE MODE //////////////////////
  {
    ...
    display.setTextSize(1);
    if (needHigh == 1) {
    display.drawLine(0, 16, 12, 16, WHITE); // LINE DIVISOR
    display.drawLine(0, 26, 12, 26, WHITE); // LINE DIVISOR
    display.drawLine(12, 16, 12, 26, WHITE); // LINE DIVISOR
...
void refreshtimingLow() {
  display.display();
  delay(120);
  display.clearDisplay();
}
void refreshtimingHigh() {
  display.display();
  delay(500);
  display.clearDisplay();
}
...
void logoo(){
  ...
  display.println(F(" EXPOSURE METER v3.2 "));
